...
const TESTIMONIALS = [
  {
    name: "Raka Pradipta",
    username: "@raka.trips",
    body: "Receipt OCR in seconds review, tweak, and submit.",
    img: "https://avatar.vercel.sh/raka",
  },
  {
    name: "Aulia Putri",
    username: "@auliarmdnii",
    body: "Settlements link to Basescan easy to verify.",
    img: "https://avatar.vercel.sh/aulia",
  },
  {
    name: "Kevin Lim",
    username: "@kevinlim",
    body: "Multi currency totals without manual FX math.",
    img: "https://avatar.vercel.sh/kevin",
  },
  {
    name: "Dewi Kartika",
    username: "@dewik",
    body: "Images offchain, onchain hashes for privacy.",
    img: "https://avatar.vercel.sh/dewi",
  },
  {
    name: "Arif Nugroho",
    username: "@arif.ng",
    body: "Net settlement shows exactly who pays whom.",
    img: "https://avatar.vercel.sh/arif",
  },
  {
    name: "Sinta Wardana",
    username: "@sintawr",
    body: "Base Sepolia demo made wallet onboarding simple.",
    img: "https://avatar.vercel.sh/sinta",
  },
  {
    name: "Bagus Mahendra",
    username: "@bagus.m",
    body: "Snappy UI with real time balance updates.",
    img: "https://avatar.vercel.sh/bagus",
  },
  {
    name: "Yuki Tan",
    username: "@yukitan",
    body: "6 digit code join was effortless.",
    img: "https://avatar.vercel.sh/yuki",
  },
  {
    name: "Nadia Putri",
    username: "@nadia.putri",
    body: "Onchain history reduces back and forth disputes.",
